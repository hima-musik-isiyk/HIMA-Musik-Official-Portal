...
- **Scheduled Reconciliation:** Vercel Cron calls `/api/notion/sync-cms` every 30 minutes. This is the fallback for missed webhook deliveries and keeps Supabase as the reliable runtime read layer.
