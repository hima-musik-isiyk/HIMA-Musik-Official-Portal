    ...
    <footer className="bg-stone-950 border-t border-stone-900 pt-32 pb-16 px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-8">
        ...
        <div className="md:col-span-3">
          <h4 className="text-md font-bold uppercase tracking-[0.4em] text-white mb-10">
            Navigasi
          </h4>
          <ul className="space-y-6 text-sm uppercase tracking-[0.3em] text-stone-500">
            <li>
        ...
        <div className="md:col-span-3">
          ...
          <ul className="space-y-6 text-sm uppercase tracking-[0.2em] text-stone-500 min-w-0">
