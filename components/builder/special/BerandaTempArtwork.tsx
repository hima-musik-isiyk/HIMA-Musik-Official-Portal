...
const BerandaTempArtwork: React.FC<HomeProps> = ({ heroSection, jelajahi }) => {
  const pathname = "/";

  // Initialize to false to match server-side default
  ...
  useEffect(() => {
    // Sync with universal entrance logic after mount
    ...
    <div className="w-full">
      ...
      {FEATURES.ALLOW_PENDAFTARAN && (
        <section
          ...
          className="border-t border-white/5 bg-stone-950 px-6 py-24 md:py-32"
        >
          <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
            <div>
              ...
              >
                Jadi{" "}
                <span className="text-gold-500 font-light italic">
                  Pengurus
                </span>{" "}
                HIMA
              </h2>
              <p
                data-animate="up"
                className="mt-5 max-w-xl text-sm leading-relaxed text-neutral-400"
              >
